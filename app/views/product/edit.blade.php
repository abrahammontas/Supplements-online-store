...
<div class="row">
    <div class="span12">
    <h1>Productos <span class="lead pull-right">Editar Productos</span></h1>
    <hr>
  ...
  {{ Form::model($product, array('route' => array('admin/productos.update', $product->id),'method'=>'put','files' => true)) }}
